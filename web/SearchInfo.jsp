    ...
    <center><u><font color="black" size="6">Flight Information</font></u><br><br><br>
        <table border="1" cellspacing="5">
            <tr>
                ...
                <td style="color:white">Intermediate Airport Code</td>
                <td style="color:white">Arrival Airport Code</td>
                <td style="color:white">Source Departure Time</td>
                <td style="color:white">Source Arrival Time</td>
                <td style="color:white">Intermediate Departure Time</td>
                <td style="color:white">Destination Arrival Time</td>
            </tr>
            <%
            ...
            <tr>
                ...
                <td><% out.print(" "+((FareInfoBean) fareData.get(i)).getSourceTime());%></td>
                <td> <% out.print(" "+((FareInfoBean) fareData.get(i)).getInterTime());%></td>
                <td><% out.print(" "+((FareInfoBean) fareData.get(i)).getInterTime1());%></td>
